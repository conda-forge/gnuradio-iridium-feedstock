...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/gnuradio-iridium-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/gnuradio-iridium-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
pixi add gnuradio-iridium
# for installing globally
pixi global install gnuradio-iridium
```
...
It is possible to list all of the versions of `gnuradio-iridium` available on your platform:
...
```
pixi search gnuradio-iridium --channel conda-forge
```
